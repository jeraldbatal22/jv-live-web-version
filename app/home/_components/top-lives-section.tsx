...
interface TopLiveSectionSectionProps {
  data: any;
}

const TopLiveSectionSection = ({ data }: TopLiveSectionSectionProps) => {
  return (
    <div>
      <div className="flex items-center justify-between px-1 sm:px-0">
        <h3 className="py-3 text-lg sm:text-xl md:text-title-sm md:py-5">Top Lives</h3>
...
export default TopLiveSectionSection;
