...
export const loginSchema = z.object({
  email: z
    .email('Please enter a valid email address').min(1, 'Email is required'),
  password: z
    .string()
...
export const createPasswordSchema = z.object({
  password: z
    ...
    .regex(/^(?=.*[a-zA-Z])(?=.*\d)(?=.*[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?])/, 'Password must contain letters, numbers and special characters'),
  confirmPassword: z
    .string()
